...
<head>
    ...
    <title>Neue Position erstellen</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">Neue Position erstellen</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="unit_name" id="unit_name" 
                                               ...
                                               value="{{ old('unit_name', 'Stunden') }}" required>
                                        @error('unit_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="card bg-light">
                                    <div class="card-body">
                                        <h6>Berechnung:</h6>
                                        <div id="calculation">
                                            Bitte füllen Sie Menge und Einzelpreis aus.
                                        </div>
                                    </div>
                                </div>
                            </div>
